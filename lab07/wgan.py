...
from modelWGAN import Generator, Discriminator
import os
import copy
import numpy as np
...
def train(dataloader, testloader, new_test_loader, generator, discriminator, args, device, logger, lastCk):
    ...
    for e in range(args.epochs):
        ...
        print("epoch:{:4d}, generator loss:{:4.5f}, discriminator loss:{:4.5f}, train socre:{:.2f}, test socre:{:.2f}, new test score:{:.2f}"\
