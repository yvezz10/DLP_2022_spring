...
def train(args, env, agent, writer):
    ...
    for episode in range(args.episode):
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                if ewma_reward > best_ewma and ewma_reward > 200:
                    best_ewma = ewma_reward
                    last_save_epoch = episode
    ...
    print("last model saved at {} episode".format(last_save_epoch))
    env.close()
...
def test(args, env, agent, writer):
    ...
    for n_episode, seed in enumerate(seeds):
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                writer.add_scalar('Test/Episode', total_reward, n_episode)
...
def main():
    ...
    parser.add_argument('--target_freq', default=1200, type=int)
