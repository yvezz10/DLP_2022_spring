...
class TD3:
    def __init__(self, args, env):
        ...
        self._policy_noise = GaussianNoise(dim=2, std = 0.2)
        # memory
    ...
    def update(self, steps):
        ...
        self._update_behavior_network(self.gamma, steps)
    ...
    def _update_behavior_network(self, gamma, total_step, policy_noise = 0.2):
        ...
        ## TODO ##
            ...
            actor_loss = -critic_net.get_Q_value(state, action).mean()
    ...
    for episode in range(args.episode):
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                if ewma_reward > best_ewma and ewma_reward >275:
...
def main():
    ...
    parser.add_argument('--seed', default=20200520, type=int)
